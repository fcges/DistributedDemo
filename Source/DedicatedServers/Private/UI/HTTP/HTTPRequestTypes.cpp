...
void FDSGameSession::Dump() const
{
	...
	UE_LOG(LogDedicatedServers, Log, TEXT("FleetId: %s"), *FleetId);
	UE_LOG(LogDedicatedServers, Log, TEXT("GameProperties count: %d"), GameProperties.Num());
...
void FDSInitiateAuthResponse::Dump() const
{
	...
	UE_LOG(LogDedicatedServers, Log, TEXT("AvailableChallenges count: %d"), AvailableChallenges.Num());
	...
	UE_LOG(LogDedicatedServers, Log, TEXT("ChallengeParameters count: %d"), ChallengeParameters.Num());
	for (const TPair<FString, FString>& Param : ChallengeParameters)
	{
		UE_LOG(LogDedicatedServers, Log, TEXT("ChallengeParameter - Key: %s, Value: %s"), *Param.Key, *Param.Value);
	}
